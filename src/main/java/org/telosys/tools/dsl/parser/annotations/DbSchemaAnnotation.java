...
public class DbSchemaAnnotation extends AnnotationDefinition {

	public DbSchemaAnnotation() {
		super(AnnotationName.DB_SCHEMA, AnnotationParamType.STRING, AnnotationScope.ENTITY);
	}
	...
	public void applyToEntity(DslModel model, DslModelEntity entity, Object paramValue) throws ParamError {
		...
		entity.setDatabaseSchema((String) paramValue);			
	}
}
