...
public class DefaultValueAnnotation extends AnnotationDefinition {

	public DefaultValueAnnotation() {
		super(AnnotationName.DEFAULT_VALUE, AnnotationParamType.STRING, AnnotationScope.ATTRIBUTE);
	}
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelAttribute attribute,
		...
		attribute.setDefaultValue((String)paramValue);
	}
}
