...
public class LongTextAnnotation extends AnnotationDefinition {

	public LongTextAnnotation() {
		super(AnnotationName.LONG_TEXT, AnnotationParamType.NONE, AnnotationScope.ATTRIBUTE);
	}
