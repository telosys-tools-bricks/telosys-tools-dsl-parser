...
public class InMemoryRepositoryAnnotation extends AnnotationDefinition {

	public InMemoryRepositoryAnnotation() {
		super(AnnotationName.IN_MEMORY_REPOSITORY, AnnotationParamType.NONE, AnnotationScope.ENTITY);
	}
	...
	public void applyToEntity(DslModel model, DslModelEntity entity, Object paramValue) throws ParamError {
		...
		entity.setInMemoryRepository(true);
	}
}
