 ...
 *
 */
public class MinLenAnnotation extends AnnotationDefinition {

	public MinLenAnnotation() {
		super(AnnotationName.MIN_LEN, AnnotationParamType.INTEGER, AnnotationScope.ATTRIBUTE);
	}
