...
public class DomainAnnotation extends AnnotationDefinition {

	public DomainAnnotation() {
		super(AnnotationName.DOMAIN, AnnotationParamType.STRING, AnnotationScope.ENTITY);
	}
	...
	public void applyToEntity(DslModel model, DslModelEntity entity, Object paramValue) throws ParamError {
		...
		entity.setDomain((String)paramValue);
	}
}
