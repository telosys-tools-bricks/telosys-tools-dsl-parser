...
public class DbTypeAnnotation extends AnnotationDefinition {

	public DbTypeAnnotation() {
		super(AnnotationName.DB_TYPE, AnnotationParamType.STRING, AnnotationScope.ATTRIBUTE);
	}
	...
	public void apply(DslModel model, DslModelEntity entity, DslModelAttribute attribute,
		...
		attribute.setDatabaseType((String)paramValue);
	}
}
