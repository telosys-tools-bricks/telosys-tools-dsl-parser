...
public abstract class DomainAnnotationOrTag {
	...
	public BigDecimal getParameterAsBigDecimal() {
		// if ( numberParameter instanceof BigDecimal ) { // null is not an
		// instanceof anything
		// return (BigDecimal) numberParameter;
		// }
		// return null ;
		if (parameter instanceof BigDecimal) { // null is not an instanceof
												// anything
	...
	public Integer getParameterAsInteger() {
		// if ( numberParameter instanceof Integer ) { // null is not an
		// instanceof anything
		// return (Integer) numberParameter;
		// }
		// return null ;
		if (parameter instanceof Integer) { // null is not an instanceof
											// anything
	...
	public Boolean getParameterAsBoolean() {
		...
		if (parameter instanceof Boolean) { // null is not an instanceof
											// anything
	...
	public List<?> getParameterAsList() {
		// return booleanParameter;
		if (parameter instanceof List<?>) { // null is not an instanceof
											// anything
	...
	public FkElement getParameterAsFKElement() {
		if (parameter instanceof FkElement) { // null is not an instanceof
												// anything
