...
public class DbTableAnnotation extends AnnotationDefinition {

	public DbTableAnnotation() {
		super(AnnotationName.DB_TABLE, AnnotationParamType.STRING, AnnotationScope.ENTITY);
	}
	...
	public void applyToEntity(DslModel model, DslModelEntity entity, Object paramValue) throws ParamError {
		...
		entity.setDatabaseTable((String) paramValue);
	}
}
