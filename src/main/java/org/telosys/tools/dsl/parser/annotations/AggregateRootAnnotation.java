...
public class AggregateRootAnnotation extends AnnotationDefinition {

	public AggregateRootAnnotation() {
		super(AnnotationName.AGGREGATE_ROOT, AnnotationParamType.NONE, AnnotationScope.ENTITY);
	}
