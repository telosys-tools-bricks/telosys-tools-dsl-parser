...
public class ExtendsAnnotation extends AnnotationDefinition {

	public ExtendsAnnotation() {
		super(AnnotationName.EXTENDS, AnnotationParamType.STRING, AnnotationScope.ENTITY);
	}
	...
	public void applyToEntity(DslModel model, DslModelEntity entity, Object paramValue) throws ParamError {
		...
		entity.setSuperClass((String) paramValue);
	}
}
