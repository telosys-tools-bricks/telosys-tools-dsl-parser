...
public class DbCatalogAnnotation extends AnnotationDefinition {

	public DbCatalogAnnotation() {
		super(AnnotationName.DB_CATALOG, AnnotationParamType.STRING, AnnotationScope.ENTITY);
	}
	...
	public void applyToEntity(DslModel model, DslModelEntity entity, Object paramValue) throws ParamError {
		...
		entity.setDatabaseCatalog((String) paramValue);			
	}
}
