 ...
 *
 */
public class OrphanRemovalAnnotation extends AnnotationDefinition {

	public OrphanRemovalAnnotation() {
		super(AnnotationName.ORPHAN_REMOVAL, AnnotationParamType.NONE, AnnotationScope.LINK);
	}
