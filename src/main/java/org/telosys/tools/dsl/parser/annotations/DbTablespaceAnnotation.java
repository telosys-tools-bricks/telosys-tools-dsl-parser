...
public class DbTablespaceAnnotation extends AnnotationDefinition {

	public DbTablespaceAnnotation() {
		super(AnnotationName.DB_TABLESPACE, AnnotationParamType.STRING, AnnotationScope.ENTITY);
	}
	...
	public void applyToEntity(DslModel model, DslModelEntity entity, Object paramValue) throws ParamError {
		...
		entity.setDatabaseTablespace((String) paramValue);			
	}
}
