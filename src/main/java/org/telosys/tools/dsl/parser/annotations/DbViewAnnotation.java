...
public class DbViewAnnotation extends AnnotationDefinition {

	public DbViewAnnotation() {
		super(AnnotationName.DB_VIEW, AnnotationParamType.NONE, AnnotationScope.ENTITY);
	}
