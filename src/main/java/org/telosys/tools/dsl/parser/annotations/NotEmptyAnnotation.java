...
public class NotEmptyAnnotation extends AnnotationDefinition {

	public NotEmptyAnnotation() {
		super(AnnotationName.NOT_EMPTY, AnnotationParamType.NONE, AnnotationScope.ATTRIBUTE);
	}
