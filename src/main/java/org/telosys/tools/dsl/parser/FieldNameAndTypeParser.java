...
public class FieldNameAndTypeParser {
	...
	private void throwParsingException(Field field, String message) {
		String errorMessage = entityNameFromFileName + " : " + message + " [line " + field.getLineNumber() + "]";
		throw new DslParserException(errorMessage);
	}

	public FieldNameAndType parseFieldNameAndType(Field field) {
...
//		checkFieldTypeName(field, fieldTypeName);
	 ...
	 */
	void checkFieldNameAndType(Field field, String fieldNameAndType) {
	...
	private void checkPositions(Field field, int separatorIndex, int cardinalityOpen, int cardinalityClose) {
		if (separatorIndex < 0) {
	 ...
	 * @param fieldName
	 */
	void checkFieldName(Field field, String fieldName) {
	 ...
	 * @param fieldName
	 */
	void checkFieldTypeWithCardinality(Field field, String fieldTypeWithCardinality) {
	 ...
	 * @return
	 */
	String getFieldTypeWithoutCardinality(Field field, String fieldTypeWithCardinality) {
	 ...
	 * @return
	 */
	int getFieldTypeCardinality(Field field, String fieldTypeWithCardinality) {
	 ...
	 * @return
	 */
	private DomainType getFieldDomainType(Field field, String typeName) {
