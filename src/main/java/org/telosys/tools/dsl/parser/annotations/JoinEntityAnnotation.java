...
public class JoinEntityAnnotation extends AnnotationDefinition {

	public JoinEntityAnnotation() {
		super(AnnotationName.JOIN_ENTITY, AnnotationParamType.NONE, AnnotationScope.ENTITY);
	}
