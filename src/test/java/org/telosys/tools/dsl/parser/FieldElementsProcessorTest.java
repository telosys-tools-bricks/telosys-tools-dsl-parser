...
import org.telosys.tools.dsl.parser.FieldElementsProcessor;
...
public class FieldElementsProcessorTest {
	...
	//--------------------------------------------------------------------------
	@Test
	public void testExtractAdditionalElements() throws DslModelError  {
		List<String> entitiesNames = Arrays.asList("Country", "Employee");
		FieldElementsProcessor processor = new FieldElementsProcessor("Country", entitiesNames);
	...
	public void testExtractAdditionalElementsErr1() throws DslModelError  {
		List<String> entitiesNames = Arrays.asList("Country", "Employee");
		FieldElementsProcessor processor = new FieldElementsProcessor("Country", entitiesNames);
	...
	@Test (expected=DslModelError.class)
	public void testExtractAdditionalElementsErr2() throws DslModelError  {
		List<String> entitiesNames = Arrays.asList("Country", "Employee");
		FieldElementsProcessor processor = new FieldElementsProcessor("Country", entitiesNames);
	...
	@Test (expected=DslModelError.class)
	public void testExtractAdditionalElementsErr3() throws DslModelError  {
		List<String> entitiesNames = Arrays.asList("Country", "Employee");
		FieldElementsProcessor processor = new FieldElementsProcessor("Country", entitiesNames);
